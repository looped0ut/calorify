...
document.getElementById("welcomeText").innerText =
  `Goal: ${data.dietaryGoal} | Activity: ${data.activityLevel}`;
...
const tdee = Math.round(bmr * activityMap[data.activityLevel]);
...
if (data.activityLevel === "Active" || data.activityLevel === "Very Active") score += 20;
if (data.generalLifestyle === "Balanced") score += 10;
...
if (data.dietaryGoal === "Weight Loss")
  advice.push("Focus on calorie deficit with high-protein foods.");

if (data.dietaryGoal === "Weight Gain")
...
if (Array.isArray(data.healthBackground) && !data.healthBackground.includes("None"))
